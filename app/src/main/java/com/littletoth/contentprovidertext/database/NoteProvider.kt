...
import com.littletoth.contentprovidertext.database.NotesDatabaseHelper.Companion.TABLE_NOTES
    ...
    override fun delete(uri: Uri, selection: String?, selectionArgs: Array<String>?): Int {
        if(mUriMatcher.match(uri) == NOTES_BY_ID) {
           val db: SQLiteDatabase = dbHelper.writableDatabase
            ...
            throw UnsupportedSchemeException("URL invalida para exclusão")
        }
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri? {
        if(mUriMatcher.match(uri) == NOTES) {
           val db: SQLiteDatabase = dbHelper.writableDatabase
            ...
            throw UnsupportedSchemeException("URL invalida para inserção")
        }
    }
    ...
    override fun query(
       ...
       return when {
           ...
           mUriMatcher.match(uri) == NOTES_BY_ID -> {
               ...
               throw UnsupportedSchemeException("Uri não implrmentada.")
           }
       }
    }
